  ...
  <div class="container">
    <form action="/addadvice" method="POST">
        ...
        <div class="form-group">
          <label for="exampleFormControlTextarea1">Add advice</label>
          <textarea  name ="data"class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
   ...
   <table class="table">
    <thead class="" style=" background-color:#38a3eb; color:#fff;">
      <tr>
        <th scope="col">#</th>
