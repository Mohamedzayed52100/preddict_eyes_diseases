...
<img style="width:60px; height:60px; position: absolute; important! top:10px;left:10px;" src="images/logo.jpg">
</a> --}}
<body>
  ...
  <main>
    <form action="/upload" method="POST" enctype="multipart/form-data">
      @csrf
      <input class="mohamed" required type="file" name="file" accept=".jpg,.jpeg,.png">
      <p style="color:#38a3eb;">Drag your images here or click in this area</p>
